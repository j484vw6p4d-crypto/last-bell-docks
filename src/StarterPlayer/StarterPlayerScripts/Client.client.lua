...
local title = label("Title", UDim2.new(0.5, -160, 0, 12), UDim2.new(0, 320, 0, 40), "Last Bell  ·  BETA 0.1", Color3.fromRGB(255, 220, 120))
title.TextSize = 20
local phaseLbl = label("Phase", UDim2.new(0.5, -90, 0, 58), UDim2.new(0, 180, 0, 32), "DAY", Color3.fromRGB(180, 255, 180))
local stats = label("Stats", UDim2.new(0, 16, 1, -96), UDim2.new(0, 280, 0, 40), "Coins 0  |  Carry none")
local hint = label("Hint", UDim2.new(1, -360, 1, -52), UDim2.new(0, 344, 0, 36), "[E] Harvest  [F] Stock  [Q] Sell  [R] Steal  [P] Rebirth")
hint.TextSize = 13
local toast = label("Toast", UDim2.new(0.5, -180, 0, 98), UDim2.new(0, 360, 0, 32), "Friends beta — coins reset when you leave")
...
print("[Last Bell] BETA 0.1 client")
